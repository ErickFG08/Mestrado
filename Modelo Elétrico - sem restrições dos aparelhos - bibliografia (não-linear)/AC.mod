...
var y0{AC,Ot,Of} binary;			
var y1{AC,Ot,Of} binary;
var y2{AC,Ot,Of} binary;
var y3{AC,Ot,Of} binary;
var y4{AC,Ot,Of} binary;
...
#--------------------------------------------- Funções Objetivo --------------------------------------
	...
	# Consumo de energia dos aparelhos de AC
		...
		minimize fo_consumo_ac_com_tarifa:
			(sum {w in AC, t in Ot, f in Of} Pac[w,t,f] * dT * tarifa_artigo[t] * preco_energia);
	...
	# Geração de energia dos PFVs
		...
		minimize fo_consumo_pfv_com_tarifa:
			sum {p in PFV, t in Ot, f in Of} pot_pfv[p,t,f] * dT * tarifa_artigo[t] * preco_energia;
	...
	# Consumo de energia das Baterias
		...
		minimize fo_consumo_bat_com_tarifa:
			sum {b in BAT, t in Ot, f in Of} (Pbateria_carga[b,t,f] + Pbateria_descarga[b,t,f]) * dT * tarifa_artigo[t] * preco_energia;
		...
		minimize fo_consumo_reativa_bat_com_tarifa:
			sum {b in BAT, t in Ot, f in Of} (Qbateria_descarga[b,t,f]) * dT * tarifa_artigo[t] * preco_energia;
	...
	# Consumo de energia dos Aparelhos
		...
		minimize fo_consumo_aparelhos_com_tarifa:
			sum {w in AC, t in Ot, f in Of}(Pac[w,t,f] + Pbateria_carga[w,t,f] + Pbateria_descarga[w,t,f] + pot_pfv[w,t,f]) * dT * tarifa_artigo[t] * preco_energia;
...
# APARELHOS DE AR CONDICIONADO
	...
	## Modificadores ##
		...
		subject to modificador_Hac_freq_1{n in AC, t in Ot, f in Of}:
			mod_Hac_freq[n,t,f] = 
			  (0.0134 * z1[n,t,f] + y1[n,t,f] * 0.1465)
			+ (0.0100 * z2[n,t,f] + y2[n,t,f] * 0.2834)
			+ (0.0068 * z3[n,t,f] + y3[n,t,f] * 0.4774)
			+ (0.0042 * z4[n,t,f] + y4[n,t,f] * 0.6751);

		subject to modificador_Hac_freq_2{n in AC, t in Ot, f in Of}: 
			y0[n,t,f] + y1[n,t,f] + y2[n,t,f] + y3[n,t,f] + y4[n,t,f] = 1;
			
		subject to modificador_Hac_freq_3{n in AC, t in Ot, f in Of}: 
			0 <= z0[n,t,f];

		subject to modificador_Hac_freq_4{n in AC, t in Ot, f in Of}: 
			z0[n,t,f] <= 20 * y0[n,t,f];

		subject to modificador_Hac_freq_5{n in AC, t in Ot, f in Of}: 
			20 * y1[n,t,f] <= z1[n,t,f];

		subject to modificador_Hac_freq_6{n in AC, t in Ot, f in Of}: 
			z1[n,t,f] <= 40 * y1[n,t,f];
		
		subject to modificador_Hac_freq_7{n in AC, t in Ot, f in Of}: 
			40 * y2[n,t,f] <= z2[n,t,f];

		subject to modificador_Hac_freq_8{n in AC, t in Ot, f in Of}: 
			z2[n,t,f] <= 60 * y2[n,t,f];
			
		subject to modificador_Hac_freq_9{n in AC, t in Ot, f in Of}: 
			60 * y3[n,t,f] <= z3[n,t,f];

		subject to modificador_Hac_freq_10{n in AC, t in Ot, f in Of}: 
			z3[n,t,f] <= 78 * y3[n,t,f];
			
		subject to modificador_Hac_freq_11{n in AC, t in Ot, f in Of}: 
			78 * y4[n,t,f] <= z4[n,t,f];

		subject to modificador_Hac_freq_12{n in AC, t in Ot, f in Of}: 
			z4[n,t,f] <= 90 * y4[n,t,f];
				
		subject to modificador_Hac_freq_13{n in AC, t in Ot, f in Of}: 
			frequency_ac[n,t,f] = z0[n,t,f] + z1[n,t,f] + z2[n,t,f] + z3[n,t,f] + z4[n,t,f];	
